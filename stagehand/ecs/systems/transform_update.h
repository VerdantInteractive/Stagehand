...
{
    world.system<Transform2D, const stagehand::Position2D, const stagehand::Rotation2D, const stagehand::Scale2D>(stagehand::names::systems::TRANSFORM_UPDATE_2D)
    ...
    world.system<Transform3D, const stagehand::Position3D, const stagehand::Rotation3D, const stagehand::Scale3D>(stagehand::names::systems::TRANSFORM_UPDATE_3D)
        .kind(stagehand::PreRender)
        .multi_threaded()
