...
#define VECTOR(Name, ElementType, ...) \
    struct Name { \
        ...
        Name& operator=(const std::vector<ElementType>& v) { value = v; return *this; } \
        Name& operator=(std::vector<ElementType>&& v) { value = std::move(v); return *this; } \
...
#define ARRAY(Name, ElementType, Size, ...) \
    struct Name { \
        ...
        Name& operator=(const std::array<ElementType, Size>& v) { value = v; return *this; } \
        Name& operator=(std::array<ElementType, Size>&& v) { value = std::move(v); return *this; } \
        ElementType& operator[](std::size_t i) { return value[i]; } \
        const ElementType& operator[](std::size_t i) const { return value[i]; } \
