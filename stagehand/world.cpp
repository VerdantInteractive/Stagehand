    ...
    void FlecsWorld::cleanup_instanced_renderer_rids() {
        ...
        godot::Variant FlecsWorld::get_component(const godot::String &component_name, uint64_t entity_id) {
            ...
            void FlecsWorld::_bind_methods() {
                ...
                godot::ClassDB::bind_method(godot::D_METHOD("instantiate_prefab", "prefab_name", "components"), &FlecsWorld::instantiate_prefab,
                                            DEFVAL(Dictionary()));
                ...
                ADD_PROPERTY(godot::PropertyInfo(godot::Variant::INT, "progress_tick", godot::PROPERTY_HINT_ENUM, "Rendering,Physics,Manual"),
                             "set_progress_tick", "get_progress_tick");
                ...
                ADD_PROPERTY(
                    godot::PropertyInfo(godot::Variant::DICTIONARY, "world_configuration", godot::PROPERTY_HINT_TYPE_STRING,
