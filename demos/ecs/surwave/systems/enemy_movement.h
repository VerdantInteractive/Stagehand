    ...
    >("Enemy Movement")
        ...
        .run([](flecs::iter &it) {
            ...
            while (it.next()) {
                ...
                flecs::field<const PlayerPosition> player_position_field = it.field<const PlayerPosition>(2);
                flecs::field<const EnemyBoidMovementSettings> movement_settings_field = it.field<const EnemyBoidMovementSettings>(3);
