...
func _ready() -> void:
	...
	assert_approx(lod_details[0]["visibility_range_begin"], 0.0, "LOD 0 visibility_range_begin")
	assert_approx(lod_details[0]["visibility_range_end"], 50.0, "LOD 0 visibility_range_end")
	assert_eq(lod_details[0]["visibility_range_fade_mode"], InstancedRenderer3DLODConfiguration.VISIBILITY_RANGE_FADE_DISABLED, "LOD 0 visibility_range_fade_mode")

	# LOD 1: medium-high detail
	assert_true(lod_details[1]["mesh_rid_valid"], "LOD 1 mesh RID is valid")
	assert_approx(lod_details[1]["visibility_range_begin"], 50.0, "LOD 1 visibility_range_begin")
	assert_approx(lod_details[1]["visibility_range_end"], 100.0, "LOD 1 visibility_range_end")
	assert_eq(lod_details[1]["visibility_range_fade_mode"], InstancedRenderer3DLODConfiguration.VISIBILITY_RANGE_FADE_SELF, "LOD 1 visibility_range_fade_mode")

	# LOD 2: medium-low detail
	assert_true(lod_details[2]["mesh_rid_valid"], "LOD 2 mesh RID is valid")
	assert_approx(lod_details[2]["visibility_range_begin"], 100.0, "LOD 2 visibility_range_begin")
	assert_approx(lod_details[2]["visibility_range_end"], 200.0, "LOD 2 visibility_range_end")
	assert_eq(lod_details[2]["visibility_range_fade_mode"], InstancedRenderer3DLODConfiguration.VISIBILITY_RANGE_FADE_DEPENDENCIES, "LOD 2 visibility_range_fade_mode")

	# LOD 3: lowest detail, farthest range
	assert_true(lod_details[3]["mesh_rid_valid"], "LOD 3 mesh RID is valid")
	assert_approx(lod_details[3]["visibility_range_begin"], 200.0, "LOD 3 visibility_range_begin")
	assert_approx(lod_details[3]["visibility_range_end"], 500.0, "LOD 3 visibility_range_end")
	assert_eq(lod_details[3]["visibility_range_fade_mode"], InstancedRenderer3DLODConfiguration.VISIBILITY_RANGE_FADE_SELF, "LOD 3 visibility_range_fade_mode")
